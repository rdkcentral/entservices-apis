...
def generate_methods_toc(methods, classname):
    ...
    for method in methods:
        ...
        if events_dict:
            ...
            event_str = 'NA'
        toc += f"| [{method_name}](#{method_name}) | {method_info['brief'] or method_info['details']} | {event_str} |\n"
    return toc
...
def generate_properties_toc(properties, classname):
    ...
    for prop in properties:
        ...
        if events_dict:
            ...
            event_str = 'NA'
        toc += f"| [{property_name}](#{property_name}){super_script} | {property_info['brief'] or property_info['details']} | {event_str} |\n"
    return toc
