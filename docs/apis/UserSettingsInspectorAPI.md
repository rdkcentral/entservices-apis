...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "<callsign>.getMigrationState",
  "params": {
...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "<callsign>.getMigrationStates"
}
```
