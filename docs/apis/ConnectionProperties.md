...
| result.data | string (base64) | mandatory | *...* |
...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "<callsign>.widthincentimeters"
}
```
...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "<callsign>.heightincentimeters"
}
```
...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "<callsign>.isaudiopassthrough"
}
```
