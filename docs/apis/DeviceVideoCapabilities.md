...
> ``supportedvideodisplays`` is an alternative name for this  This name is **deprecated** and may be removed in the future. It is not recommended for use in new implementations.
...
> ``defaultresolution`` is an alternative name for this  This name is **deprecated** and may be removed in the future. It is not recommended for use in new implementations.
...
> ``supportedresolutions`` is an alternative name for this  This name is **deprecated** and may be removed in the future. It is not recommended for use in new implementations.
...
> ``supportedhdcp`` is an alternative name for this  This name is **deprecated** and may be removed in the future. It is not recommended for use in new implementations.
...
> ``hostedid`` is an alternative name for this  This name is **deprecated** and may be removed in the future. It is not recommended for use in new implementations.
