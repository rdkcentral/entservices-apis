...
| :-------- | :-------- | :-------- |
| params | object |  |
| params.demuxerId | string | string - Demuxer ID (default is "0") |
### Results
| Name | Type | Description |
| :-------- | :-------- | :-------- |
| result | object |  |
| result.channel | string | string - Channel address |
| result.result | integer | uint32_t - Result code |
...
| :-------- | :-------- | :-------- |
| result | object |  |
| result.seekPosInSeconds | integer | uint64_t - TSB seek position offset from live in seconds |
| result.result | integer | uint32_t - Result code |
...
| :-------- | :-------- | :-------- |
| result | object |  |
| result.maxSizeInBytes | integer | uint64_t - Maximum TSB size in bytes |
| result.currentSizeInBytes | integer | uint64_t - Current TSB size in bytes |
| result.currentSizeInSeconds | integer | uint64_t - Current TSB size in seconds |
| result.seekPosInBytes | integer | uint64_t - Current TSB seek position offset from live in bytes |
| result.seekPosInSeconds | integer | uint64_t - TSB seek position offset from live in seconds |
| result.trickPlaySpeed | integer | int16_t - Current trick play speed and direction |
| result.streamSourceLost | bool | bool - Boolean indicating if the buffer source is lost |
| result.streamSourceLossCount | integer | uint64_t - Number of times streaming was lost |
| result.result | integer | uint32_t - Result code |
...
| :-------- | :-------- | :-------- |
| result | object |  |
| result.tracing | bool | bool - Tracing enable (true) / disable (false) |
| result.result | integer | uint32_t - Result code |
...
| :-------- | :-------- | :-------- |
| result | object |  |
| result.speed | integer | int16_t - New trick play speed (negative=rewind, positive=fast forward) |
| result.result | integer | uint32_t - Result code |
...
| params | object |  |
| params.demuxerId | string | string - Demuxer ID (default is "0") |
| params.channel | string | string - Channel address |
### Results
| Name | Type | Description |
| :-------- | :-------- | :-------- |
| result | object |  |
...
| params | object |  |
| params.demuxerId | string | string - Demuxer ID (default is "0") |
| params.seekPosInSeconds | integer | uint64_t - TSB seek position offset from live in seconds |
### Results
| Name | Type | Description |
| :-------- | :-------- | :-------- |
| result | object |  |
...
| :-------- | :-------- | :-------- |
| params | object |  |
| params.tracing | bool | bool - Tracing enable (true) / disable (false) |
### Results
| Name | Type | Description |
| :-------- | :-------- | :-------- |
| result | object |  |
...
| params | object |  |
| params.demuxerId | string | string - Demuxer ID (default is "0") |
| params.speed | integer | int16_t - New trick play speed (negative=rewind, positive=fast forward) |
### Results
| Name | Type | Description |
| :-------- | :-------- | :-------- |
| result | object |  |
...
| params | object |  |
| params.speed | integer | int16_t - New trick play speed (negative=rewind, positive=fast forward) |
| params.muxId | integer | uint8_t - Stream muxId |
...
```json
{
    "jsonrpc": 2.0,
    "id": 9,
    "method": "org.rdk.LinearPlaybackControl.speedchanged",
    "params": {
        "speed": 0,
        "muxId": 0
    }
