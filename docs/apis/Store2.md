...
> ``setValue`` is an alternative name for this 
...
> ``getValue`` is an alternative name for this 
...
> ``deleteKey`` is an alternative name for this 
...
> ``deleteNamespace`` is an alternative name for this 
