...
| result.configMetadata.envVars | std::string |  |
...
| result.configMetadata.appType | uint32_t |  |
...
| params.priority | bool |  |
| params.retries | uint32_t |  |
| params.rateLimit | uint64_t |  |
### Results
| Name | Type | Description |
| :-------- | :-------- | :-------- |
...
| result.configMetadata.fireboltVersion | std::string |  |
| result.configMetadata.enableDebugger | bool |  |
| result.appMetadata | string | App Metadata XXX: appContextPath ?! |
...
| Name | Type | Description |
| :-------- | :-------- | :-------- |
| result.state | PackageLifecycleState |  |
