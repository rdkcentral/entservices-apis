...
| result.configMetadata.unpackedPath | string | The path where application packages are unpacked |
...
| result.config.unpackedPath | string | The path where application packages are unpacked |
