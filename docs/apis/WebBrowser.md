...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "<callsign>.collectgarbage"
}
```
...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "<callsign>.localstorageenabled"
}
```
...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "<callsign>.httpcookieacceptpolicy"
}
```
...
Provides access to the send legacy $badger 
