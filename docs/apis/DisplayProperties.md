...
DisplayProperties interface methods:

| Method | Description |
| :-------- | :-------- |
| [getCurrentColorimetry](#method_getCurrentColorimetry) | Returns the active colorimetry standard of the current connected video port |

<a id="method_getCurrentColorimetry"></a>
## *getCurrentColorimetry [<sup>method</sup>](#head_Methods)*
...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "<callsign>.getCurrentColorimetry"
}
```
...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "<callsign>.quantizationrange"
}
```
