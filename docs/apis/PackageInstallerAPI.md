...
| Name | Type | M/O | Description |
| :-------- | :-------- | :-------- | :-------- |
| result | string | mandatory | *...* (must be one of the following: *GENERAL_FAILURE, INVALID_METADATA_FAILURE, NONE, PACKAGE_MISMATCH_FAILURE, PERSISTENCE_FAILURE, SIGNATURE_VERIFICATION_FAILURE*) |
...
| result[#].state | string | mandatory | State (must be one of the following: *INSTALLATION_BLOCKED, INSTALLED, INSTALLING, INSTALL_FAILURE, UNINSTALLED, UNINSTALLING, UNINSTALL_BLOCKED, UNINSTALL_FAILURE*) |
| result[#].digest | string | mandatory | Digest |
| result[#].sizeKb | integer | mandatory | SizeKb |
| result[#].packageType | string | mandatory | Type of the package as defined by the OCI package spec |
  ...
  "result": [
    {
      ...
      "digest": "...",
      "sizeKb": 0,
      "packageType": "base, runtime, application, service, resource"
    }
  ]
}
```
...
| result.capabilities | string | mandatory | Comma-separated lowercase runtime capability tokens supported by the application runtime |
| result.ralfPkgPath | string | mandatory | Filesystem path containing metadata information for RALF packages |
...
| Name | Type | M/O | Description |
| :-------- | :-------- | :-------- | :-------- |
| result | string | mandatory | *...* (must be one of the following: *INSTALLATION_BLOCKED, INSTALLED, INSTALLING, INSTALL_FAILURE, UNINSTALLED, UNINSTALLING, UNINSTALL_BLOCKED, UNINSTALL_FAILURE*) |
...
<a id="method_getConfigForPackage"></a>
...
| result.config.capabilities | string | mandatory | Comma-separated lowercase runtime capability tokens supported by the application runtime |
| result.config.ralfPkgPath | string | mandatory | Filesystem path containing metadata information for RALF packages |
...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "<callsign>.getConfigForPackage",
  "params": {
    "fileLocator": "..."
  }
}
