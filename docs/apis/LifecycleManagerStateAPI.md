...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "<callsign>.stateChangeComplete",
  "params": {
    "appId": "...",
    "stateChangedId": 0,
    "success": false
...
| params.oldLifecycleState | string | mandatory | *...* (must be one of the following: *ACTIVE, HIBERNATED, INITIALIZING, LOADING, PAUSED, SUSPENDED, TERMINATING, UNLOADED*) |
| params.newLifecycleState | string | mandatory | *...* (must be one of the following: *ACTIVE, HIBERNATED, INITIALIZING, LOADING, PAUSED, SUSPENDED, TERMINATING, UNLOADED*) |
...
```json
{
  ...
  "params": {
    "appId": "...",
    "appInstanceId": "...",
    "oldLifecycleState": "LOADING",
    "newLifecycleState": "LOADING",
    "navigationIntent": "..."
  }
}
```
