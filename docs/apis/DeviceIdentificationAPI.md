...
<a id="head_Device_Identification_API"></a>
...
(Defined by [DeviceIdentification.json](https://github.com/rdkcentral/ThunderInterfaces/blob/master/interfaces/DeviceIdentification.json))
...
| :-------- | :-------- | :-------- |
| [deviceidentification](#property_deviceidentification) | read-only | Device paltform specific information |
...
| :-------- | :-------- | :-------- | :-------- |
| (property) | object | mandatory | Device paltform specific information |
...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "<callsign>.deviceidentification"
}
```
