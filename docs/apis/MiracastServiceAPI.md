...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "<callsign>.acceptClientConnection",
  "params": {
    "requestStatus": "..."
  }
}
...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "<callsign>.stopClientConnection",
  "params": {
    "mac": "...",
    "name": "..."
  }
...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "<callsign>.updatePlayerState",
  "params": {
    "mac": "...",
    "state": "INITIATED",
    "reason_code": 0
...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "<callsign>.setP2PBackendDiscovery",
  "params": {
    "enabled": false
  }
}
