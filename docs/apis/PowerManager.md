...
| [removePowerModeChangeAcknowledgementClient](#removePowerModeChangeAcknowledgementClient) | Unregister a client from receiving power mode change acknowledgement requests |
...
Register a client to receive power mode change acknowledgement requests
...
| :-------- | :-------- | :-------- |
| result | object |  |
| result.acknowledgeClientId | integer | Unique identifier for the acknowledgement client to be used when calling `PowerModeChangeAcknowledgement` |
...
Acknowledge a power state change
...
Unregister a client from receiving power mode change acknowledgement requests
...
| [onPowerModeChangeAcknowledgementRequested](#onPowerModeChangeAcknowledgementRequested) | Power mode change acknowledgement requested event |
...
Power mode change acknowledgement requested event
...
| params.transactionId | int | transaction id to be used when calling PowerModeChangeAcknowledgement |
