...
| result.response.netType | integer | The type of network  |
...
| result.remoteData[#].remoteId | integer | This integer is the remote ID number, assigned by the network e.g. 1 |
| result.remoteData[#].deviceId | integer | The device ID number that is assigned by the network e.g. 35 |
