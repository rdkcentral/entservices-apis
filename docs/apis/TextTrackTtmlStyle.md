...
| [getTtmlStyleOverrides](#method_getTtmlStyleOverrides) | Gets the global TTML style overrides |
...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "<callsign>.setTtmlStyleOverrides",
  "params": {
    "style": "..."
  }
}
...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "<callsign>.getTtmlStyleOverrides"
}
```
