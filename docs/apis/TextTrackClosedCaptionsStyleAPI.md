...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "<callsign>.setClosedCaptionsStyle",
  "params": {
    "style": {
...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "<callsign>.getClosedCaptionsStyle"
}
```
...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "<callsign>.setFontOpacity",
  "params": {
    "opacity": 0
  }
}
...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "<callsign>.getFontOpacity"
}
```
...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "<callsign>.setFontEdgeColor",
  "params": {
    "color": "..."
  }
}
...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "<callsign>.getFontEdgeColor"
}
```
...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "<callsign>.setBackgroundColor",
  "params": {
    "color": "..."
  }
}
...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "<callsign>.getBackgroundColor"
}
```
...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "<callsign>.setBackgroundOpacity",
  "params": {
    "opacity": 0
  }
}
...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "<callsign>.getBackgroundOpacity"
}
```
...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "<callsign>.setWindowColor",
  "params": {
    "color": "..."
  }
}
...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "<callsign>.getWindowColor"
}
```
...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "<callsign>.setWindowOpacity",
  "params": {
    "opacity": 0
  }
}
...
```json
{
  "jsonrpc": "2.0",
  "id": 42,
  "method": "<callsign>.getWindowOpacity"
}
```
