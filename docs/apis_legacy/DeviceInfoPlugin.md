...
| [osname](#osname) <sup>RO</sup> | Operating system name |
| [osversion](#osversion) <sup>RO</sup> | Operating system version |
...
```json
{
    ...
    "id": 42,
    "result": {
        "osVersion": "alphanumerical string"
    }
}
```
