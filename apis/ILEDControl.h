...
namespace WPEFramework
{
    namespace Exchange
    {
        ...
        struct EXTERNAL ILEDControl : virtual public Core::IUnknown
        {
            ...
            // @brief Gets the list of LED states supported by the platform
            ...
            // @param success Boolean value indicating if the operation was successful
            ...
            // @retval Core::hresult S_OK on success, error code otherwise
            ...
            // @details Queries and returns the current operational state of the LED on the device. The returned state indicates the device's current operational mode
            // @param ledState: LEDState structure containing the current LED state (e.g., ACTIVE, STANDBY, WPS_CONNECTING)
            ...
            // @details Sets the device LED to one of the states available from GetSupportedLEDStates. The state change is applied immediately on the device
