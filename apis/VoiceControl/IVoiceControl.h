...
namespace WPEFramework {
    ...
    namespace Exchange {
        ...
        struct EXTERNAL IVoiceControl : virtual public Core::IUnknown {
            ...
            virtual void SendNotify_(const char* eventName, Thunder::Core::JSON::VariantContainer& parameters) = 0;
            ...
            virtual Core::hresult VoiceStatus(const Thunder::Core::JSON::VariantContainer& parameters, Thunder::Core::JSON::VariantContainer& response /* out */) = 0;
            ...
            virtual Core::hresult ConfigureVoice(const Thunder::Core::JSON::VariantContainer& parameters, Thunder::Core::JSON::VariantContainer& response /* out */) = 0;
            ...
            virtual Core::hresult SetVoiceInit(const Thunder::Core::JSON::VariantContainer& parameters, Thunder::Core::JSON::VariantContainer& response /* out */) = 0;
            ...
            virtual Core::hresult SendVoiceMessage(const Thunder::Core::JSON::VariantContainer& parameters, Thunder::Core::JSON::VariantContainer& response /* out */) = 0;
            ...
            virtual Core::hresult VoiceSessionByText(const Thunder::Core::JSON::VariantContainer& parameters, Thunder::Core::JSON::VariantContainer& response /* out */) = 0; // DEPRECATED
            ...
            virtual Core::hresult VoiceSessionTypes(const Thunder::Core::JSON::VariantContainer& parameters, Thunder::Core::JSON::VariantContainer& response /* out */) = 0;
            ...
            virtual Core::hresult VoiceSessionRequest(const Thunder::Core::JSON::VariantContainer& parameters, Thunder::Core::JSON::VariantContainer& response /* out */) = 0;
            ...
            virtual Core::hresult VoiceSessionTerminate(const Thunder::Core::JSON::VariantContainer& parameters, Thunder::Core::JSON::VariantContainer& response /* out */) = 0;
            ...
            virtual Core::hresult VoiceSessionAudioStreamStart(const Thunder::Core::JSON::VariantContainer& parameters, Thunder::Core::JSON::VariantContainer& response /* out */) = 0;
            // End methods
