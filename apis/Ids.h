...
namespace Exchange {
	...
	ID_TEXT_TRACK_CLOSED_CAPTIONS_STYLE_NOTIFICATION = ID_TEXT_TRACK + 2,
        ...
        ID_TEXT_TRACK_WEBVTT_STYLE                   = ID_TEXT_TRACK + 8,
        ID_TEXT_TRACK_WEBVTT_STYLE_NOTIFICATION      = ID_TEXT_TRACK + 9,
	...
	ID_HDCPPROFILE_NOTIFICATION                  = ID_HDCPPROFILE + 1,
        ...
        ID_DEVICESETTINGS_COMPOSITEIN                       = ID_ENTOS_OFFSET + 0x590,
        ID_DEVICESETTINGS_COMPOSITEIN_NOTIFICATION          = ID_DEVICESETTINGS_COMPOSITEIN + 1,

        ID_DEVICESETTINGS_DISPLAY                           = ID_ENTOS_OFFSET + 0x5A0,
        ...
        ID_DEVICESETTINGS_FPD                               = ID_ENTOS_OFFSET + 0x5B0,
        ID_DEVICESETTINGS_FPD_NOTIFICATION                  = ID_DEVICESETTINGS_FPD + 1,

        ID_DEVICESETTINGS_HDMIIN                            = ID_ENTOS_OFFSET + 0x5C0,
        ...
        ID_DEVICESETTINGS_HOST                              = ID_ENTOS_OFFSET + 0x5D0,

        ID_DEVICESETTINGS_VIDEODEVICE                       = ID_ENTOS_OFFSET + 0x5E0,
