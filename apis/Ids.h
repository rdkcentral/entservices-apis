...
namespace Exchange {
	...
	ID_HDCPPROFILE_NOTIFICATION                  = ID_HDCPPROFILE + 1,
        ...
        ID_USER_PLUGIN                               = ID_ENTOS_OFFSET + 0x470,

        ID_DEVICESETTINGS_MANAGER_AUDIO                             = ID_ENTOS_OFFSET + 0x480,
        ...
        ID_DEVICESETTINGS_MANAGER_COMPOSITEIN                       = ID_ENTOS_OFFSET + 0x490,
        ID_DEVICESETTINGS_MANAGER_COMPOSITEIN_NOTIFICATION          = ID_DEVICESETTINGS_MANAGER_COMPOSITEIN + 1,

        ID_DEVICESETTINGS_MANAGER_DISPLAY                           = ID_ENTOS_OFFSET + 0x4A0,
        ...
        ID_DEVICESETTINGS_MANAGER_FPD                               = ID_ENTOS_OFFSET + 0x4B0,
        ID_DEVICESETTINGS_MANAGER_FPD_NOTIFICATION                  = ID_DEVICESETTINGS_MANAGER_FPD + 1,
 
        ID_DEVICESETTINGS_MANAGER_HDMIIN                            = ID_ENTOS_OFFSET + 0x4C0,
        ...
        ID_DEVICESETTINGS_MANAGER_HOST                              = ID_ENTOS_OFFSET + 0x4D0,
        ID_DEVICESETTINGS_MANAGER_HOST_NOTIFICATION                 = ID_DEVICESETTINGS_MANAGER_HOST + 1,

        ID_DEVICESETTINGS_MANAGER_VIDEODEVICE                       = ID_ENTOS_OFFSET + 0x4E0,
        ...
        ID_DEVICESETTINGS_MANAGER_VIDEOPORT                         = ID_ENTOS_OFFSET + 0x4F0,
