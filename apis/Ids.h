...
namespace Exchange {
	...
	ID_HDCPPROFILE_NOTIFICATION                  = ID_HDCPPROFILE + 1,
        ...
        ID_DEVICESETTINGS                               = ID_ENTOS_OFFSET + 0x530,

        ID_DEVICESETTINGS_AUDIO                             = ID_ENTOS_OFFSET + 0x540,
        ...
        ID_DEVICESETTINGS_AUDIO_TYPECONFIG_ITERATOR         = ID_DEVICESETTINGS_AUDIO + 6,
        ID_DEVICESETTINGS_AUDIO_PORTCONFIG_ITERATOR         = ID_DEVICESETTINGS_AUDIO + 7,
        ID_DEVICESETTINGS_AUDIO_COMPRESSIONMAP_ITERATOR     = ID_DEVICESETTINGS_AUDIO + 8,
        ID_DEVICESETTINGS_AUDIO_ENCODINGMAP_ITERATOR        = ID_DEVICESETTINGS_AUDIO + 9,
        ID_DEVICESETTINGS_AUDIO_STEREOMODEMAP_ITERATOR      = ID_DEVICESETTINGS_AUDIO + 10,

        ID_DEVICESETTINGS_COMPOSITEIN                       = ID_ENTOS_OFFSET + 0x550,
        ID_DEVICESETTINGS_COMPOSITEIN_NOTIFICATION          = ID_DEVICESETTINGS_COMPOSITEIN + 1,

        ID_DEVICESETTINGS_DISPLAY                           = ID_ENTOS_OFFSET + 0x560,
        ...
        ID_DEVICESETTINGS_FPD                               = ID_ENTOS_OFFSET + 0x570,
        ID_DEVICESETTINGS_FPD_NOTIFICATION                  = ID_DEVICESETTINGS_FPD + 1,
        ID_DEVICESETTINGS_FPD_COLORCONFIG_ITERATOR          = ID_DEVICESETTINGS_FPD + 2,
        ID_DEVICESETTINGS_FPD_INDICATORCONFIG_ITERATOR      = ID_DEVICESETTINGS_FPD + 3,
        ID_DEVICESETTINGS_FPD_TEXTDISPLAYCONFIG_ITERATOR    = ID_DEVICESETTINGS_FPD + 4,
        ID_DEVICESETTINGS_FPD_COLORBINDING_ITERATOR         = ID_DEVICESETTINGS_FPD + 5,
        ID_DEVICESETTINGS_FPD_INDICATORCOLORMAP_ITERATOR    = ID_DEVICESETTINGS_FPD_COLORBINDING_ITERATOR,

        ID_DEVICESETTINGS_HDMIIN                            = ID_ENTOS_OFFSET + 0x580,
        ...
        ID_DEVICESETTINGS_HOST                              = ID_ENTOS_OFFSET + 0x590,
        ID_DEVICESETTINGS_HOST_NOTIFICATION                 = ID_DEVICESETTINGS_HOST + 1,

        ID_DEVICESETTINGS_VIDEODEVICE                       = ID_ENTOS_OFFSET + 0x5A0,
        ...
        ID_DEVICESETTINGS_VIDEODEVICE_CONFIG_ITERATOR       = ID_DEVICESETTINGS_VIDEODEVICE + 3,

        ID_DEVICESETTINGS_VIDEOPORT                         = ID_ENTOS_OFFSET + 0x5B0,
        ID_DEVICESETTINGS_VIDEOPORT_NOTIFICATION            = ID_DEVICESETTINGS_VIDEOPORT + 1,
        ID_DEVICESETTINGS_VIDEOPORT_TYPECONFIG_ITERATOR     = ID_DEVICESETTINGS_VIDEOPORT + 2,
        ID_DEVICESETTINGS_VIDEOPORT_PORTCONFIG_ITERATOR     = ID_DEVICESETTINGS_VIDEOPORT + 3,
        ID_DEVICESETTINGS_VIDEOPORT_RESOLUTION_ITERATOR     = ID_DEVICESETTINGS_VIDEOPORT + 4,
        ID_DEVICESETTINGS_VIDEOPORT_RESOLUTIONMAP_ITERATOR  = ID_DEVICESETTINGS_VIDEOPORT + 5,

        //Test plugin for Devicesettings plugin. TODO: will remove in final review PR
        ID_USER_PLUGIN                               = ID_ENTOS_OFFSET + 0x5C0
