...
namespace Exchange {
	...
	ID_HDCPPROFILE_NOTIFICATION                  = ID_HDCPPROFILE + 1,
        ...
        ID_DEVICE_SETTINGS_AUDIO_PROFILE_ITERATOR           = ID_DEVICESETTINGS_MANAGER_AUDIO + 2,
        ID_DSAUDIO_SAD_ITERATOR                             = ID_DEVICESETTINGS_MANAGER_AUDIO + 3,
        ...
        ID_DEVICESETTINGS_HDMIIN_CAPS_ITERATOR              = ID_DEVICESETTINGS_MANAGER_HDMIIN + 3,
            ID_DEVICESETTINGS_HDMIIN_GAMELIST_ITERATOR      = ID_DEVICESETTINGS_MANAGER_HDMIIN + 4,
