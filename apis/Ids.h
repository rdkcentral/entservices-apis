...
namespace Exchange {
	...
	ID_HDCPPROFILE_NOTIFICATION                  = ID_HDCPPROFILE + 1,
        ...
        ID_DEVICESETTINGS_AUDIO_COMPRESSIONMAP_ITERATOR     = ID_DEVICESETTINGS_AUDIO + 6,
        ID_DEVICESETTINGS_AUDIO_ENCODINGMAP_ITERATOR        = ID_DEVICESETTINGS_AUDIO + 7,
        ID_DEVICESETTINGS_AUDIO_STEREOMODEMAP_ITERATOR      = ID_DEVICESETTINGS_AUDIO + 8,
        ...
        ID_DEVICESETTINGS_FPD_INDICATORCOLORMAP_ITERATOR    = ID_DEVICESETTINGS_FPD + 2,
        ...
        ID_DEVICESETTINGS_VIDEOPORT_RESOLUTIONMAP_ITERATOR  = ID_DEVICESETTINGS_VIDEOPORT + 3,
