...
namespace Exchange {
	...
	ID_HDCPPROFILE_NOTIFICATION                  = ID_HDCPPROFILE + 1,
        ...
        ID_DEVICE_SETTINGS_AUDIO_ENCODING_ITERATOR          = ID_DEVICESETTINGS_MANAGER_AUDIO + 2,
        ID_DEVICE_SETTINGS_AUDIO_COMPRESSION_ITERATOR       = ID_DEVICESETTINGS_MANAGER_AUDIO + 3,
		ID_DEVICE_SETTINGS_AUDIO_PROFILE_ITERATOR           = ID_DEVICESETTINGS_MANAGER_AUDIO + 4,
		ID_DEVICE_SETTINGS_AUDIO_STEREOMODE_ITERATOR        = ID_DEVICESETTINGS_MANAGER_AUDIO + 5,
        ...
        ID_DEVICE_SETTINGS_DISPLAY_RESOLUTION_ITERATOR      = ID_DEVICESETTINGS_MANAGER_DISPLAY + 2,
        ...
        ID_DEVICESETTINGS_MANAGER_HDMI_NOTIFICATION         = ID_DEVICESETTINGS_MANAGER_HDMIIN + 1,
        ID_DEVICESETTINGS_HDMIIN_PORTCONNECTION_ITERATOR    = ID_DEVICESETTINGS_MANAGER_HDMIIN + 2,
        ID_DEVICESETTINGS_HDMIIN_GAMELIST_ITERATOR          = ID_DEVICESETTINGS_MANAGER_HDMIIN + 3,
        ...
        ID_DEVICE_SETTINGS_VIDEO_CODEC_PROFILE_ITERATOR     = ID_DEVICESETTINGS_MANAGER_VIDEODEVICE + 2,
