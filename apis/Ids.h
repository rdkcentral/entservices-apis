...
namespace Exchange {
	...
	ID_HDCPPROFILE_NOTIFICATION                  = ID_HDCPPROFILE + 1,
        ...
        ID_DEVICESETTINGS_MANAGER_DISPLAY                           = ID_ENTOS_OFFSET + 0x500,
        ...
        ID_DEVICESETTINGS_MANAGER_FPD                               = ID_ENTOS_OFFSET + 0x510,
        ID_DEVICESETTINGS_MANAGER_FPD_NOTIFICATION                  = ID_DEVICESETTINGS_MANAGER_FPD + 1,

        ID_DEVICESETTINGS_MANAGER_HDMIIN                            = ID_ENTOS_OFFSET + 0x520,
        ...
        ID_DEVICESETTINGS_MANAGER_HOST                              = ID_ENTOS_OFFSET + 0x530,
        ID_DEVICESETTINGS_MANAGER_HOST_NOTIFICATION                 = ID_DEVICESETTINGS_MANAGER_HOST + 1,

        ID_DEVICESETTINGS_MANAGER_VIDEODEVICE                       = ID_ENTOS_OFFSET + 0x540,
        ...
        ID_DEVICESETTINGS_MANAGER_VIDEOPORT                         = ID_ENTOS_OFFSET + 0x550,
