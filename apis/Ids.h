...
namespace Exchange {
	...
	ID_HDCPPROFILE_NOTIFICATION                  = ID_HDCPPROFILE + 1,
        ...
        ID_DEVICESETTINGS_MANAGER_COMPOSITEIN       = ID_DEVICESETTINGS_MANAGER + 2,
        ID_DEVICESETTINGS_MANAGER_DISPLAY   = ID_DEVICESETTINGS_MANAGER + 3,
        ID_DEVICESETTINGS_MANAGER_DISPLAY_NOTIFICATION         = ID_DEVICESETTINGS_MANAGER + 4,
        ID_DEVICESETTINGS_MANAGER_FPD        = ID_DEVICESETTINGS_MANAGER + 5,
         ID_DEVICESETTINGS_MANAGER_HDMIIN    = ID_DEVICESETTINGS_MANAGER + 6,
        ID_DEVICESETTINGS_MANAGER_HDMI_NOTIFICATION   = ID_DEVICESETTINGS_MANAGER + 7,
        ID_DEVICESETTINGS_MANAGER_HOST          = ID_DEVICESETTINGS_MANAGER + 8,
        ID_DEVICESETTINGS_MANAGER_VIDEODEVICE   = ID_DEVICESETTINGS_MANAGER + 9,
        ID_DEVICESETTINGS_MANAGER_VIDEOPORT          = ID_DEVICESETTINGS_MANAGER + 10
    };
}
}
