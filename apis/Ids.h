...
namespace Exchange {
	...
	ID_HDCPPROFILE_NOTIFICATION                  = ID_HDCPPROFILE + 1,
        ...
        ID_DEVICESETTINGS_AUDIO                             = ID_ENTOS_OFFSET + 0x490,
        ...
        ID_DEVICESETTINGS_COMPOSITEIN                       = ID_ENTOS_OFFSET + 0x4A0,
        ID_DEVICESETTINGS_COMPOSITEIN_NOTIFICATION          = ID_DEVICESETTINGS_COMPOSITEIN + 1,

        ID_DEVICESETTINGS_DISPLAY                           = ID_ENTOS_OFFSET + 0x4B0,
        ...
        ID_DEVICESETTINGS_FPD                               = ID_ENTOS_OFFSET + 0x4C0,
        ID_DEVICESETTINGS_FPD_NOTIFICATION                  = ID_DEVICESETTINGS_FPD + 1,
 
        ID_DEVICESETTINGS_HDMIIN                            = ID_ENTOS_OFFSET + 0x4D0,
        ...
        ID_DEVICESETTINGS_HOST                              = ID_ENTOS_OFFSET + 0x4E0,
        ID_DEVICESETTINGS_HOST_NOTIFICATION                 = ID_DEVICESETTINGS_HOST + 1,

        ID_DEVICESETTINGS_VIDEODEVICE                       = ID_ENTOS_OFFSET + 0x4F0,
        ...
        ID_DEVICESETTINGS_VIDEOPORT                         = ID_ENTOS_OFFSET + 0x500,
        ...
        ID_USER_PLUGIN                               = ID_ENTOS_OFFSET + 0x510
    }; // enum IDS
