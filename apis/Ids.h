...
namespace Exchange {
	...
	ID_USER_PLUGIN				     = ID_ENTOS_OFFSET + 0x3F0,

        ID_DEVICESETTINGS_MANAGER                                   = ID_ENTOS_OFFSET + 0x400,
        ID_DEVICESETTINGS_MANAGER_AUDIO                             = ID_DEVICESETTINGS_MANAGER + 1,
        ID_DEVICESETTINGS_MANAGER_AUDIO_NOTIFICATION                = ID_DEVICESETTINGS_MANAGER_AUDIO + 1,
        ID_DEVICESETTINGS_MANAGER_AUDIO_ENCODING_ITERATOR           = ID_DEVICESETTINGS_MANAGER_AUDIO + 2,
        ID_DEVICESETTINGS_MANAGER_AUDIO_COMPRESSION_ITERATOR        = ID_DEVICESETTINGS_MANAGER_AUDIO + 3,
        ID_DEVICESETTINGS_MANAGER_AUDIO_PROFILE_ITERATOR            = ID_DEVICESETTINGS_MANAGER_AUDIO + 4,
        ID_DEVICESETTINGS_MANAGER_AUDIO_STEREOMODE_ITERATOR         = ID_DEVICESETTINGS_MANAGER_AUDIO + 5,

        ID_DEVICESETTINGS_MANAGER_COMPOSITEIN                       = ID_ENTOS_OFFSET + 0x410,
        ID_DEVICESETTINGS_MANAGER_COMPOSITEIN_NOTIFICATION          = ID_DEVICESETTINGS_MANAGER_COMPOSITEIN + 1,

        ID_DEVICESETTINGS_MANAGER_DISPLAY                           = ID_ENTOS_OFFSET + 0x420,
        ID_DEVICESETTINGS_MANAGER_DISPLAY_NOTIFICATION              = ID_DEVICESETTINGS_MANAGER_DISPLAY + 1,
        ID_DEVICESETTINGS_MANAGER_DISPLAY_RESOLUTION_ITERATOR       = ID_DEVICESETTINGS_MANAGER_DISPLAY + 2,
        ID_DEVICESETTINGS_MANAGER_DISPLAY_HOTPLUG_NOTIFICATION      = ID_DEVICESETTINGS_MANAGER_DISPLAY + 3,

        ID_DEVICESETTINGS_MANAGER_FPD                               = ID_ENTOS_OFFSET + 0x430,
        ID_DEVICESETTINGS_MANAGER_FPD_NOTIFICATION                  = ID_DEVICESETTINGS_MANAGER_FPD + 1,

        ID_DEVICESETTINGS_MANAGER_HDMIIN                            = ID_ENTOS_OFFSET + 0x440,
        ID_DEVICESETTINGS_MANAGER_HDMIIN_NOTIFICATION               = ID_DEVICESETTINGS_MANAGER_HDMIIN + 1,
        ID_DEVICESETTINGS_MANAGER_HDMIIN_PORTCONNECTION_ITERATOR    = ID_DEVICESETTINGS_MANAGER_HDMIIN + 2,
        ID_DEVICESETTINGS_MANAGER_HDMIIN_GAMELIST_ITERATOR          = ID_DEVICESETTINGS_MANAGER_HDMIIN + 3,

        ID_DEVICESETTINGS_MANAGER_HOST                              = ID_ENTOS_OFFSET + 0x450,
        ID_DEVICESETTINGS_MANAGER_HOST_NOTIFICATION                 = ID_DEVICESETTINGS_MANAGER_HOST + 1,

        ID_DEVICESETTINGS_MANAGER_VIDEODEVICE                       = ID_ENTOS_OFFSET + 0x460,
        ID_DEVICESETTINGS_MANAGER_VIDEODEVICE_NOTIFICATION          = ID_DEVICESETTINGS_MANAGER_VIDEODEVICE + 1,
        ID_DEVICESETTINGS_MANAGER_VIDEO_CODEC_PROFILE_ITERATOR      = ID_DEVICESETTINGS_MANAGER_VIDEODEVICE + 2,

        ID_DEVICESETTINGS_MANAGER_VIDEOPORT                         = ID_ENTOS_OFFSET + 0x470,
        ID_DEVICESETTINGS_MANAGER_VIDEOPORT_NOTIFICATION            = ID_DEVICESETTINGS_MANAGER_VIDEOPORT + 1
