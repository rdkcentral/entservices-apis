...
namespace Exchange {
	...
	ID_TELEMETRYMETRICS                          = ID_ENTOS_OFFSET + 0x3F0
        ...
        ID_USER_PLUGIN                               = ID_ENTOS_OFFSET + 0x400,

        ID_DEVICESETTINGS_MANAGER                                   = ID_ENTOS_OFFSET + 0x410,
        ...
        ID_DEVICESETTINGS_MANAGER_COMPOSITEIN                       = ID_ENTOS_OFFSET + 0x420,
        ID_DEVICESETTINGS_MANAGER_COMPOSITEIN_NOTIFICATION          = ID_DEVICESETTINGS_MANAGER_COMPOSITEIN + 1,

        ID_DEVICESETTINGS_MANAGER_DISPLAY                           = ID_ENTOS_OFFSET + 0x430,
        ...
        ID_DEVICESETTINGS_MANAGER_FPD                               = ID_ENTOS_OFFSET + 0x440,
        ID_DEVICESETTINGS_MANAGER_FPD_NOTIFICATION                  = ID_DEVICESETTINGS_MANAGER_FPD + 1,

        ID_DEVICESETTINGS_MANAGER_HDMIIN                            = ID_ENTOS_OFFSET + 0x450,
        ...
        ID_DEVICESETTINGS_MANAGER_HOST                              = ID_ENTOS_OFFSET + 0x460,
        ID_DEVICESETTINGS_MANAGER_HOST_NOTIFICATION                 = ID_DEVICESETTINGS_MANAGER_HOST + 1,

        ID_DEVICESETTINGS_MANAGER_VIDEODEVICE                       = ID_ENTOS_OFFSET + 0x470,
        ...
        ID_DEVICESETTINGS_MANAGER_VIDEOPORT                         = ID_ENTOS_OFFSET + 0x480,
