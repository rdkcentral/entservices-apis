    ...
    namespace Dolby {
	    ...
	    // @brief set application audio config
           ...
           // @param enable: true/false
            ...
            virtual uint32_t GetApplicationAudioConfig(const std::string& audioConfig /* @text audioConfig */, bool &enable /* @out */) = 0;
            ...
            virtual uint32_t GetApplicationAudioConfigList(IAudioConfigListIterator*& applicationAudioConfigs /* @out */) const = 0;
