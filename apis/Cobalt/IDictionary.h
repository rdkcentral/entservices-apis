...
namespace Exchange {
    ...
    struct EXTERNAL IDictionary : virtual public Core::IUnknown {
        ...
        struct EXTERNAL IIterator : virtual public Core::IUnknown {
            ...
            // @details Moves the iterator forward by one position.
            virtual bool Next() = 0;
        ...
        // @example value: "exampleValue"
        // retval core::ERROR_NONE if the operation was successful, core::ERROR_NOT_FOUND if the key does not exist.
