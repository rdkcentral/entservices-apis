    ...
    namespace Exchange {
        ...
        struct EXTERNAL IAVInput : virtual public Core::IUnknown {
            ...
            struct EXTERNAL IGameFeatureStatusUpdateNotification : virtual public Core::IUnknown {
                ...
                // @details This notification is generated when the status of a supported HDMI
                // game feature changes on an HDMI input port. Currently, this event is used to report 
                // Auto Low Latency Mode (ALLM) status changes. The notification includes the HDMI input port identifier, the game feature name, and the current status of the feature.
            ...
            struct EXTERNAL IAviContentTypeUpdateNotification : virtual public Core::IUnknown {
                ...
                // @param aviContentType - in - new Content type received for the active hdmi input port and the possible integer values indicates 
                // following accordingly 0 - Graphics, 1 - Photo, 2 - Cinema, 3 - Game, 4 - Invalid data
            ...
            // @param success - out - Whether the request succeeded
            // @param allmSupport: [Type: Boolean] The ALLM support in EDID
            // @param successResult: [Type: Object] Structural element containing the operation success status flag
            // @example portId: "HDMI0"
            ...
            // @param portId - in - An ID of an HDMI/Composite Input port as returned by the getInputDevices method
            // @param allmSupport - out - The ALLM support in EDID
            // @param success - out - Whether the request succeeded
            // @example portId: "HDMI0"
            // @example allmSupport: true
            // @example success: true
            ...
            // @param portId - in - The ID of the input device to set the VRR
            ...
            // @details Retrieves the Variable Refresh Rate (VRR) support bit from the EDID structure for the specified HDMI input port.
            // @param portId - in - The ID of the input device to get the VRR
