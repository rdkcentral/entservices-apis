...
namespace Exchange {
    ...
    struct EXTERNAL IDeviceInfo : virtual public Core::IUnknown {
        ...
        // @details Retrieves the device model number or SKU.
        // @param deviceModelNo: Device model number
        // @example deviceModelNo: {"sku":"BCM7445"}
        // @param success: Indicates whether the operation was successful
        // @example success: true
        // @retval ErrorCode::ERROR_NONE: Indicates success
        // @retval ErrorCode::ERROR_GENERAL: Indicates failure
        ...
        // @details Retrieves the user-friendly model name of the device.
        // @param deviceModel: Device model name
        // @example deviceModel: {"model":"X1 DVR"}
        // @param success: Indicates whether the operation was successful
        // @example success: true
        // @retval ErrorCode::ERROR_NONE: Indicates success
        // @retval ErrorCode::ERROR_GENERAL: Indicates failure
        ...
        // @details Retrieves the type of device.
        ...
        // @details Retrieves the System-on-Chip (SOC) name used by the device.
        ...
        // @details Retrieves the distributor or partner identifier associated with the device.
        // @param deviceDistId: Partner ID or distributor ID for device
        // @example deviceDistId: {"distributorid":"COMCAST"}
        // @param success: Indicates whether the operation was successful
        // @example success: true
        // @retval ErrorCode::ERROR_NONE: Indicates success
        // @retval ErrorCode::ERROR_GENERAL: Indicates failure
        ...
        // @details Retrieves the brand name associated with the device.
        // @param brand: Device brand name
        // @example deviceBrand: {"brand":"Xfinity"}
        // @param success: Indicates whether the operation was successful
        // @example success: true
        // @retval ErrorCode::ERROR_NONE: Indicates success
        // @retval ErrorCode::ERROR_GENERAL: Indicates failure
        ...
        // @details Retrieves the software release version installed on the device.
        // @param releaseversion: ReleaseVersion of the Image
        // @example deviceReleaseVer: {"releaseversion":"RDK_5.0.0"}
        // @param success: Indicates whether the operation was successful
        // @example success: true
        // @retval ErrorCode::ERROR_NONE: Indicates success
        // @retval ErrorCode::ERROR_GENERAL: Indicates failure
        ...
        // @details Retrieves the chipset used by the device.
        // @param deviceChip: Chipset of the device
        // @example deviceChip: {"chipset":"BCM7445"}
        // @param success: Indicates whether the operation was successful
        // @example success: true
        // @retval ErrorCode::ERROR_NONE: Indicates success
        // @retval ErrorCode::ERROR_GENERAL: Indicates failure
        ...
        // @details Retrieves firmware and software component version information maintained by the device.
        // @param firmwareVersionInfo: Version information
        // @example firmwareVersionInfo: {"imagename":"rdk-image","sdk":"17.3","mediarite":"6.2","yocto":"4.0","pdri":"2.1"}
        // @param success: Indicates whether the operation was successful
        // @example success: true
        // @retval ErrorCode::ERROR_NONE: Indicates success
        // @retval ErrorCode::ERROR_GENERAL: Indicates failure
        ...
        // @details Retrieves general system information including version, uptime, memory, CPU load, hostname, serial number, and system time.
        // @param systeminfo: System general information
        // @example systemInfo: {"version":"5.4#abcd1234","uptime":86400,"totalram":2147483648,"freeram":1073741824}
        // @param success: Indicates whether the operation was successful
        // @example success: true       
        // @retval ErrorCode::ERROR_NONE: Indicates success
        // @retval ErrorCode::ERROR_GENERAL: Indicates failure
        ...
        // @details Retrieves the list of network interfaces and their corresponding MAC and IP addresses.
        // @param addressesInfo: Network interface addresses
        // @example addressesInfo: [{"name":"eth0","mac":"00:11:22:33:44:55","ip":"192.168.1.10"}]
        // @param success: Indicates whether the operation was successful
        // @example success: true
        // @retval ErrorCode::ERROR_NONE: Indicates success
        // @retval ErrorCode::ERROR_GENERAL: Indicates failure
        ...
        // @details Retrieves the Ethernet MAC address of the device.
        // @param ethMac: Ethernet MAC addresses
        // @example ethernetMac: {"eth_mac":"00:11:22:33:44:55"}
        // @param success: Indicates whether the operation was successful
        // @example success: true
        // @retval ErrorCode::ERROR_NONE: Indicates success
        // @retval ErrorCode::ERROR_GENERAL: Indicates failure
        ...
        // @details Retrieves the STB MAC address assigned to the device.
        // @param estbMac: STB MAC addresses
        // @example stbMac: {"estb_mac":"00:11:22:33:44:66"}
        // @param success: Indicates whether the operation was successful
        // @example success: true
        // @retval ErrorCode::ERROR_NONE: Indicates success
        // @retval ErrorCode::ERROR_GENERAL: Indicates failure
        ...
        // @details Retrieves the WiFi MAC address of the device.
        // @param wifiMac: WIFI MAC addresses
        // @example wiFiMac: {"wifi_mac":"00:11:22:33:44:77"}
        // @param success: Indicates whether the operation was successful
        // @example success: true
        // @retval ErrorCode::ERROR_NONE: Indicates success
        // @retval ErrorCode::ERROR_GENERAL: Indicates failure
        ...
        // @details Retrieves the IP address currently assigned to the STB.
        ...
        // @details Retrieves the list of audio output ports supported by the device.
        // @param supportedAudioPorts: Audio ports supported on the device.
        // @example supportedAudioPorts: ["HDMI0","SPDIF","ANALOG"]
        // @param success: Indicates whether the operation was successful
        // @example success: true
        // @retval ErrorCode::ERROR_NONE: Indicates success
        // @retval ErrorCode::ERROR_GENERAL: Indicates failure
    ...
    struct EXTERNAL IDeviceAudioCapabilities : virtual public Core::IUnknown {
        ...
        // @details Retrieves the audio capabilities supported on the specified audio output port.
        // @param audioPort: Audio port name
        // @param AudioCapabilities: Audio capability
        // @example audioPort: "HDMI0"
        // @example AudioCapabilities: ["ATMOS","DOLBY_DIGITAL","MS12"]
        // @param success: Indicates whether the operation was successful
        // @example success: true
        // @retval ErrorCode::ERROR_NONE: Indicates success
        // @retval ErrorCode::ERROR_GENERAL: Indicates failure
        ...
        // @details Retrieves the MS12 audio capabilities supported on the specified audio output port.
        // @param audioPort: Audio port name
        // @example audioPort: "HDMI0"
        ...
        // @details Retrieves the MS12 audio profiles supported on the specified audio output port.
        // @param audioPort: Audio port name
        // @example audioPort: "HDMI0"
        // @param supportedMS12AudioProfiles: MS12 audio profiles
        // @example supportedMS12AudioProfiles:["MOVIE","MUSIC","VOICE"]
        // @param success: Indicates whether the operation was successful
        // @example success: true
        // @retval ErrorCode::ERROR_NONE: Indicates success
        // @retval ErrorCode::ERROR_GENERAL: Indicates failure
    ...
    struct EXTERNAL IDeviceVideoCapabilities : virtual public Core::IUnknown {
        ...
        // @details Retrieves the list of video output ports supported by the device.
        // @param supportedVideoDisplays: Video ports supported on the device
        // @example supportedVideoDisplays: ["HDMI0","HDMI1","DISPLAYPORT"]
        // @param success: Indicates whether the operation was successful
        // @example success: true
        // @retval ErrorCode::ERROR_NONE: Indicates success
        // @retval ErrorCode::ERROR_GENERAL: Indicates failure
        ...
        // @details Retrieves the default video output resolution configured for the specified video display port.
        // @param videoDisplay: Video display port name
        // @example videoDisplay: "HDMI0"
        ...
        // @details Retrieves the list of video resolutions supported by the specified video display port.
        // @param videoDisplay: Video display port name
        // @example videoDisplay: "HDMI0"
        // @example supportedResolutions: ["720p","1080p","1080p60","2160p60"]
        ...
        // @details Retrieves the EDID (Extended Display Identification Data) of the connected host device.
        // @param EDID: EDID of the host
        // @example hostEdid: {"EDID":"AP///////wAQrMLA"}
        // @param success: Indicates whether the operation was successful
        // @example success: true
        // @retval ErrorCode::ERROR_NONE: Indicates success
        // @retval ErrorCode::ERROR_GENERAL: Indicates failure
        ...
        // @details Retrieves the HDCP version supported by the specified video display port.
        // @param videoDisplay: Video display port name
        // @example videoDisplay: "HDMI0"
