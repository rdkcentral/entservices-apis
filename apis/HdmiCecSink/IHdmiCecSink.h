 ...
 namespace WPEFramework
 {
     namespace Exchange
     {
         ...
         struct EXTERNAL IHdmiCecSink : virtual public Core::IUnknown {
            ...
            using IHdmiCecSinkActivePathIterator = RPC::IIteratorType<HdmiCecSinkActivePath, ::WPEFramework::Exchange::ID_HDMI_CEC_SINK_ACTIVE_PATH_ITERATOR>;
            using IHdmiCecSinkDeviceListIterator = RPC::IIteratorType<HdmiCecSinkDevices, ::WPEFramework::Exchange::ID_HDMI_CEC_SINK_DEVICE_LIST_ITERATOR>;
