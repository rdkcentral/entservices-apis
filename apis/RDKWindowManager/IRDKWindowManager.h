...
struct EXTERNAL IRDKWindowManager : virtual public Core::IUnknown {
  ...
  virtual Core::hresult CreateDisplay(const std::string &clientId, const std::string &displayName, uint32_t displayWidth /* @default:1920 */, uint32_t displayHeight /* @default:1080 */, uint32_t virtualWidth /* @default:1920 */, uint32_t virtualHeight /* @default:1080 */, uint32_t ownerId /* @default:0 */, uint32_t groupId /* @default:0 */, bool topmost /* @default:true */, bool focus /* @default:true */) = 0;
