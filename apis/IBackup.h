...
namespace WPEFramework
{
    namespace Exchange
    {
        ...
        struct EXTERNAL IBackupManager : virtual public Core::IUnknown
        {
            ...
            // @details Invokes all registered backup providers and requests them to persist their settings into the location specified by the supplied BackupContext. The backup operation is performed for the given scenario and variant.
            // @param context: Context configuration specifying scenario, variant, and storage path for the backup operation
            ...
            // @retval Core::ERROR_NONE Successfully backed up the settings across all system providers
            ...
            // @details Invokes all registered backup providers and requests them to restore their settings from the location specified by the supplied BackupContext. The restore operation is performed for the given scenario and variant.
            // @param context: Context configuration specifying scenario, variant, and storage path from where data should be restored  
            // @example context: {"scenario": "HOSPITALITY_RESET", "variant": "generic", "persistentPath": "/opt/secure/persistent/settings_backup/"}
            // @param success: Indicates whether the operation was successful
            // @example success: true
            // @retval Core::ERROR_NONE Successfully restored the settings
            // @retval Core::ERROR_GENERAL Failed to complete the system restore process
            ...
            // @details Locates the backup directory specified by the BackupContext and removes all archived settings data associated with the given scenario and variant.
            // @param context: Context for which the backup to be deleted
            // @example context: {"scenario": "HOSPITALITY_RESET", "variant": "generic", "persistentPath": "/opt/secure/persistent/settings_backup/"}
            // @param success: Indicates whether the operation was successful
            // @example success: true
            // @retval Core::ERROR_NONE Successfully deleted the backup
            // @retval Core::ERROR_GENERAL Failed to delete the backup
        ...
        struct EXTERNAL IBackupProvider : virtual public Core::IUnknown
        {
            ...
            // @details Instructs this specific plugin or component provider to compile its internal state and persist it into the provided BackupContext directory path.
            // @param context: Context configuration containing scenario and target path details for saving this plugin's settings
            // @example context: {"scenario": "HOSPITALITY_RESET", "variant": "generic", "persistentPath": "/opt/secure/persistent/settings_backup/"}
            // @param success: Indicates whether the operation was successful
            // @example success: true
            // @retval Core::ERROR_NONE Successfully backed up component-specific settings
            // @retval Core::ERROR_GENERAL Component failed to complete its internal backup serialization
            virtual Core::hresult Backup(const BackupContext& context) = 0;

            // @text restore
            // @brief Restore settings that belong to this component.
            // @details Instructs this specific plugin or component provider to ingest saved settings data from the BackupContext location and re-apply them to its runtime configuration.
            // @param context: Context for which the restore to happen
            // @example context: {"scenario": "HOSPITALITY_RESET", "variant": "generic", "persistentPath": "/opt/secure/persistent/settings_backup/"}
            // @param success: Indicates whether the operation was successful
            // @example success: true
            // @retval Core::ERROR_NONE Successfully restored
            // @retval Core::ERROR_GENERAL Failed to complete the restore operation
            ...
            // @details Commands this specific plugin provider to purge any specialized local archives, references, or storage files created for this particular context scenario and variant.
            // @param context: Context for which the backup to be deleted
            // @example context: {"scenario": "HOSPITALITY_RESET", "variant": "generic", "persistentPath": "/opt/secure/persistent/settings_backup/"}
            // @param success: Indicates whether the operation was successful
            // @example success: true
