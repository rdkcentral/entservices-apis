...
namespace WPEFramework {
	namespace Exchange {
		/* @json @text:keep */
		struct EXTERNAL IXCast1 : virtual public Core::IUnknown {
			enum { ID = ID_XCAST1 };
			...
			struct EXTERNAL INotification : virtual public Core::IUnknown {
				...
				// @param applicationName: Registered application name
				// @param applicationId: Application instance ID
				virtual void OnRequest(const string& appName /* @text applicationName */ , const string& appID /* @text applicationId */ )  {};
      ...
      // @param model: The Model name of the device which used to update in dd.xml
			...
			// @param success: 	Whether the request succeeded
			virtual Core::hresult SetStandbyBehavior(StandbyBehavior &standbybehavior /* @text standbybehavior */, XCastSuccess& success /* @out */) = 0;
			/***************************************** setStandbyBehavior() *********************************/
			...
			// @param standbybehavior: whether to remain active or inactive during standby mode (must be one of the following: active, inactive)
			// @param success: Whether the request succeeded
			virtual uint32_t GetStandbyBehavior(StandbyBehavior &standbybehavior /* @out @text standbybehavior */, bool &success /* @out */) = 0;
			/***************************************** getStandbyBehavior() *********************************/
			...
			// @param success: 	Whether the request succeeded
			virtual Core::hresult SetFriendlyName(const string &friendlyname /* @text @in friendlyname */, XCastSuccess& success /* @out */) = 0;
			/***************************************** setFriendlyName() **********************************/
			...
			// @param friendlyname: The friendly name of the device which used to display on the client device list
			// @param success: Whether the request succeeded
			virtual string GetFriendlyName(string &friendlyname /* @out @text friendlyname */, bool &success /* @out */) = 0;
			/***************************************** getFriendlyName() *********************************/
