...
namespace WPEFramework {
    ...
    namespace Exchange {
        ...
        struct EXTERNAL IRemoteControl : virtual public Core::IUnknown {
            ...
            virtual Core::hresult GetApiVersionNumber(const WPEFramework::Core::JSON::VariantContainer& parameters, WPEFramework::Core::JSON::VariantContainer& response /* out */) = 0;
            ...
            virtual Core::hresult StartPairing(const WPEFramework::Core::JSON::VariantContainer& parameters, WPEFramework::Core::JSON::VariantContainer& response /* out */) = 0;
            ...
            virtual Core::hresult StopPairing(const WPEFramework::Core::JSON::VariantContainer& parameters, WPEFramework::Core::JSON::VariantContainer& response /* out */) = 0;
            ...
            virtual Core::hresult GetNetStatus(const WPEFramework::Core::JSON::VariantContainer& parameters, WPEFramework::Core::JSON::VariantContainer& response /* out */) = 0;
            ...
            virtual Core::hresult GetIRDBManufacturers(const WPEFramework::Core::JSON::VariantContainer& parameters, WPEFramework::Core::JSON::VariantContainer& response /* out */) = 0;
            ...
            virtual Core::hresult GetIRDBModels(const WPEFramework::Core::JSON::VariantContainer& parameters, WPEFramework::Core::JSON::VariantContainer& response /* out */) = 0;
            ...
            virtual Core::hresult GetIRCodesByAutoLookup(const WPEFramework::Core::JSON::VariantContainer& parameters, WPEFramework::Core::JSON::VariantContainer& response /* out */) = 0;
            ...
            virtual Core::hresult GetIRCodesByNames(const WPEFramework::Core::JSON::VariantContainer& parameters, WPEFramework::Core::JSON::VariantContainer& response /* out */) = 0;
            ...
            virtual Core::hresult SetIRCode(const WPEFramework::Core::JSON::VariantContainer& parameters, WPEFramework::Core::JSON::VariantContainer& response /* out */) = 0;
            ...
            virtual Core::hresult ClearIRCodes(const WPEFramework::Core::JSON::VariantContainer& parameters, WPEFramework::Core::JSON::VariantContainer& response /* out */) = 0;
            ...
            virtual Core::hresult GetLastKeypressSource(const WPEFramework::Core::JSON::VariantContainer& parameters, WPEFramework::Core::JSON::VariantContainer& response /* out */) = 0;
            ...
            virtual Core::hresult ConfigureWakeupKeys(const WPEFramework::Core::JSON::VariantContainer& parameters, WPEFramework::Core::JSON::VariantContainer& response /* out */) = 0;
            ...
            virtual Core::hresult InitializeIRDB(const WPEFramework::Core::JSON::VariantContainer& parameters, WPEFramework::Core::JSON::VariantContainer& response /* out */) = 0;
            ...
            virtual Core::hresult FindMyRemote(const WPEFramework::Core::JSON::VariantContainer& parameters, WPEFramework::Core::JSON::VariantContainer& response /* out */) = 0;
            ...
            virtual Core::hresult FactoryReset(const WPEFramework::Core::JSON::VariantContainer& parameters, WPEFramework::Core::JSON::VariantContainer& response /* out */) = 0;
            ...
            virtual Core::hresult Unpair(const WPEFramework::Core::JSON::VariantContainer& parameters, WPEFramework::Core::JSON::VariantContainer& response /* out */) = 0;
            ...
            virtual Core::hresult StartFirmwareUpdate(const WPEFramework::Core::JSON::VariantContainer& parameters, WPEFramework::Core::JSON::VariantContainer& response /* out */) = 0;
            ...
            virtual Core::hresult CancelFirmwareUpdate(const WPEFramework::Core::JSON::VariantContainer& parameters, WPEFramework::Core::JSON::VariantContainer& response /* out */) = 0;
            ...
            virtual Core::hresult StatusFirmwareUpdate(const WPEFramework::Core::JSON::VariantContainer& parameters, WPEFramework::Core::JSON::VariantContainer& response /* out */) = 0;
            // End methods
