...
namespace WPEFramework {
    ...
    namespace Exchange {
        ...
        struct EXTERNAL IRemoteControl : virtual public Core::IUnknown {
            ...
            virtual Core::hresult StartPairing(const Core::JSON::JsonObject& parameters, Core::JSON::JsonObject& response /* out */) = 0;
            ...
            virtual Core::hresult StopPairing(const Core::JSON::JsonObject& parameters, Core::JSON::JsonObject& response /* out */) = 0;
            ...
            virtual Core::hresult GetNetStatus(const Core::JSON::JsonObject& parameters, Core::JSON::JsonObject& response /* out */) = 0;
            ...
            virtual Core::hresult GetIRDBManufacturers(const Core::JSON::JsonObject& parameters, Core::JSON::JsonObject& response /* out */) = 0;
            ...
            virtual Core::hresult GetIRDBModels(const Core::JSON::JsonObject& parameters, Core::JSON::JsonObject& response /* out */) = 0;
            ...
            virtual Core::hresult GetIRCodesByAutoLookup(const Core::JSON::JsonObject& parameters, Core::JSON::JsonObject& response /* out */) = 0;
            ...
            virtual Core::hresult GetIRCodesByNames(const Core::JSON::JsonObject& parameters, Core::JSON::JsonObject& response /* out */) = 0;
            ...
            virtual Core::hresult SetIRCode(const Core::JSON::JsonObject& parameters, Core::JSON::JsonObject& response /* out */) = 0;
            ...
            virtual Core::hresult ClearIRCodes(const Core::JSON::JsonObject& parameters, Core::JSON::JsonObject& response /* out */) = 0;
            ...
            virtual Core::hresult GetLastKeypressSource(const Core::JSON::JsonObject& parameters, Core::JSON::JsonObject& response /* out */) = 0;
            ...
            virtual Core::hresult ConfigureWakeupKeys(const Core::JSON::JsonObject& parameters, Core::JSON::JsonObject& response /* out */) = 0;
            ...
            virtual Core::hresult InitializeIRDB(const Core::JSON::JsonObject& parameters, Core::JSON::JsonObject& response /* out */) = 0;
            ...
            virtual Core::hresult FindMyRemote(const Core::JSON::JsonObject& parameters, Core::JSON::JsonObject& response /* out */) = 0;
            ...
            virtual Core::hresult FactoryReset(const Core::JSON::JsonObject& parameters, Core::JSON::JsonObject& response /* out */) = 0;
            ...
            virtual Core::hresult Unpair(const Core::JSON::JsonObject& parameters, Core::JSON::JsonObject& response /* out */) = 0;
            ...
            virtual Core::hresult StartFirmwareUpdate(const Core::JSON::JsonObject& parameters, Core::JSON::JsonObject& response /* out */) = 0;
            ...
            virtual Core::hresult CancelFirmwareUpdate(const Core::JSON::JsonObject& parameters, Core::JSON::JsonObject& response /* out */) = 0;
            ...
            virtual Core::hresult StatusFirmwareUpdate(const Core::JSON::JsonObject& parameters, Core::JSON::JsonObject& response /* out */) = 0;
            // End methods
