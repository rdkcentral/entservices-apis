...
| [colourDepth](#colourDepth)<sup>RO</sup> | Provides access to display's colour Depth | NA |
| [connected](#connected)<sup>RO</sup> | Current HDMI connection status | NA |
| [eOTF](#eOTF)<sup>RO</sup> | Provides access to display's Electro optical transfer function | NA |
| [frameRate](#frameRate)<sup>RO</sup> | Provides access to Frame Rate | NA |
| [freeGpuRam](#freeGpuRam)<sup>RO</sup> | Free GPU DRAM memory (in bytes) | NA |
| [hDCPProtection](#hDCPProtection) | HDCP protocol used for transmission | NA |
| [hDRSetting](#hDRSetting)<sup>RO</sup> | HDR format in use | NA |
| [height](#height)<sup>RO</sup> | Vertical resolution of TV | NA |
| [isAudioPassthrough](#isAudioPassthrough)<sup>RO</sup> | Current audio passthrough status on HDMI | NA |
| [portName](#portName)<sup>RO</sup> | Video output port on the STB used for connection to TV | NA |
| [quantizationRange](#quantizationRange)<sup>RO</sup> | Provides access to display's Qauntization Range | NA |
| [sTBCapabilities](#sTBCapabilities)<sup>RO</sup> | HDR formats supported by STB | NA |
| [tVCapabilities](#tVCapabilities)<sup>RO</sup> | HDR formats supported by TV | NA |
| [totalGpuRam](#totalGpuRam)<sup>RO</sup> | Total GPU DRAM memory (in bytes) | NA |
| [verticalFreq](#verticalFreq)<sup>RO</sup> | Vertical Frequency | NA |
