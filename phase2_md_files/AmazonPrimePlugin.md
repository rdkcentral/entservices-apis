...
| :-------- | :-------- |:-------- |
| [factoryResetRequest](#factoryResetRequest) | Factory reset amazon prime app data | NA |
| [personalInfoRequest](#personalInfoRequest) | Request for personal access token to amazon prime app | NA |
| [setDeepLink](#setDeepLink) | Set the deeplink command for amazon prime | NA |
