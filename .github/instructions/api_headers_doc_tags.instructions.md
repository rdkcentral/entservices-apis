     ...
     ### Event Example:
      ...
      ### Struct Member Example:
             struct EXTERNAL ApplicationInfo {
                   ...
                   string query /* @text query */ /* @brief Query string that needs to be appended in launch request */;
                   string payload /* @text payload */ /* @brief Optional payload string that needs to be appended in launch request */;
                   int allowStop /* @text allowStop */ /* @brief Indicates whether the application (matching name list or prefix list) is allowed to stop (no PID presence) after launch */;
               };
